...
// vi.mock factories are hoisted above every statement in the file, so the mock
// has to be built inside vi.hoisted too or the factory reads an uninitialized
// const. This is the pattern vitest documents for exactly this error.
